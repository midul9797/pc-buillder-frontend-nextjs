...
import Processor from "@/assets/images/banner-images/processor.jpg";
import Keyboard from "@/assets/images/banner-images/keyboard.jpg";
    ...
    <div>
      <Row>
        ...
        <Col
          ...
          style={contentStyle}
        >
          <Image src={Processor} fill alt="drawing_image" />
        </Col>
      </Row>
    </div>
    {/* slider-2 */}
